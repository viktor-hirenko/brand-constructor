...
<template>
  <div class="min-h-screen bg-background flex items-center justify-center p-6">
    <div
      class="w-full max-w-[1311px] min-h-[740px] bg-card rounded-[14px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden flex"
    >
      <!-- Left: Content -->
      <div class="w-1/2 pl-12 flex flex-col justify-center">
        <div class="max-w-[560px]">
          <!-- Badge -->
          <div
            class="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-6"
          >
            <svg
          ...
          <!-- Description -->
          <p
            class="text-xl text-muted-foreground leading-7 max-w-[452px] mb-8 tracking-[-0.45px]"
          >
            Заповнить бриф для роботи над новим брендом. Оберить існуючий
            концепт, або замовʼте новий
          </p>
