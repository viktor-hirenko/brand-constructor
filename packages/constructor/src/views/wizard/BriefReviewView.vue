...
<template>
  <ReviewUnifiedView
    ...
    @open-concept-brief="store.openBriefPreview('concept', { allowEdit: false })"
    @open-external-naming-brief="store.openBriefPreview('externalNaming', { allowEdit: false })"
    @open-internal-naming-brief="store.openBriefPreview('internalNaming', { allowEdit: false })"
