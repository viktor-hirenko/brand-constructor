...
const { data: packages, loading, error, fetchData, perPage } = useApiList<PrPackage>('/api/pr-packages');
        ...
        >
          <div class="p-6 flex flex-col min-h-[280px] h-full">
            ...
            <div class="flex items-start gap-3 mb-4">
              ...
              >
                <!-- Zap -->
                <svg v-if="pkg.number === 1" class="size-6" :class="selectedId === pkg.id ? 'text-primary' : 'text-muted-foreground'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" />
                </svg>
                <!-- Rocket -->
                <svg v-else-if="pkg.number === 2" class="size-6" :class="selectedId === pkg.id ? 'text-primary' : 'text-muted-foreground'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Crown -->
                <svg v-else-if="pkg.number === 3" class="size-6" :class="selectedId === pkg.id ? 'text-primary' : 'text-muted-foreground'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L21.183 5.5a.5.5 0 0 1 .798.519l-2.834 10.246a1 1 0 0 1-.956.734H5.81a1 1 0 0 1-.957-.734L2.02 6.02a.5.5 0 0 1 .798-.519l4.276 3.664a1 1 0 0 0 1.516-.294z" />
                  <path d="M5 21h14" />
                </svg>
                <!-- Star -->
                <svg v-else-if="pkg.number === 4" class="size-6" :class="selectedId === pkg.id ? 'text-primary' : 'text-muted-foreground'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z" />
                </svg>
                <!-- Trophy -->
                <svg v-else-if="pkg.number === 5" class="size-6" :class="selectedId === pkg.id ? 'text-primary' : 'text-muted-foreground'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Sparkles -->
                <svg v-else-if="pkg.number === 6" class="size-6" :class="selectedId === pkg.id ? 'text-primary' : 'text-muted-foreground'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z" />
                  <path d="M20 3v4" /><path d="M22 5h-4" />
                  <path d="M4 17v2" /><path d="M5 18H3" />
                </svg>
                <!-- Default: Package -->
                <svg v-else class="size-6" :class="selectedId === pkg.id ? 'text-primary' : 'text-muted-foreground'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="space-y-3 flex-1">
              ...
              <div class="p-3 rounded-[10px] bg-[rgba(236,236,240,0.5)]">
                ...
                <ul class="flex flex-col gap-1.5">
                  ...
                  >
                    <svg v-if="feature.included" class="size-3 text-primary shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M20 6 9 17l-5-5" />
                    </svg>
                    <svg v-else class="size-3 text-muted-foreground shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          >
            <svg class="size-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
              <path d="M20 6 9 17l-5-5" />
            </svg>
          </div>
        </div>
    ...
    <Teleport to="body">
      ...
      >
        <div
          ...
          @click="closeDetail"
        />
        <div class="relative bg-white rounded-[14px] shadow-2xl max-w-[600px] w-full max-h-[90vh] overflow-y-auto p-8">
          <button
